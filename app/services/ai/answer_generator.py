...
4. If analyzer.visual_support.visual_required is true, a 'mermaid' or 'image' block is MANDATORY.
...
2. image: {{"type": "image", "title": "str", "search_query": "str", "recommended_websites": ["site"]}} (Strictly for physical hardware).
